...
QString qssAcousticViews()
{
    return QString(
        ...
        "}"
        "QComboBox#avPaletteCombo::down-arrow { image: url(:/icons/spin_down.svg); width: 8px; height: 6px; }"
        ...
        "QComboBox#wfCombo::down-arrow { image: url(:/icons/spin_down.svg); width: 8px; height: 6px; }"
        ...
        "QComboBox#wfFreqSelector::down-arrow { image: url(:/icons/spin_down.svg); width: 8px; height: 6px; }"
