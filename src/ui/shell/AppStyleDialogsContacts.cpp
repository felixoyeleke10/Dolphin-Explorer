...
QString qssDialogContacts()
{
    return QString(
        ...
        "  selection-background-color: transparent; selection-color: @textPrimary;"
        "}"
        ...
        "QTreeWidget#contactNavTree::item:hover:selected  { background: rgba(@accentRgb,0.34); color: @textPrimary; }"
        ...
        "QListWidget#contactThumbs::item:hover:selected  { background: rgba(@accentRgb,0.34); color: @textPrimary; }"
        ...
        "QTreeWidget#exportNavTree::item:hover:selected  { background: rgba(@accentRgb,0.34); color: @textPrimary; }"
        ...
        "QListWidget#ceTags::item:hover:selected  { background: rgba(@accentRgb,0.34); color: @textPrimary; }"
