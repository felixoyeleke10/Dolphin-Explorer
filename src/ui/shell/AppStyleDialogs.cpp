...
QString qssDialogs()
{
    return QString(
        ...
        "}"
        "QToolButton#settingsNavBtn:hover   { background: rgba(255,255,255,0.10); color: @textSecond; }"
        "QToolButton#settingsNavBtn:checked { background: rgba(@accentRgb,0.22); color: @textPrimary; }"
        "QToolButton#settingsNavBtn:pressed { background: rgba(@accentRgb,0.15); }"
