...
QString qssBase()
{
    return QString(
        ...
        "  padding: 3px 6px; border-radius: @radius3;"
        "}"
        ...
        "  background: rgba(@accentRgb,0.35); color: @textPrimary;"
        "}"
        ...
        "  background: @overlayHov;"
        "}"
        "QDoubleSpinBox::up-arrow,   QSpinBox::up-arrow   { image: url(:/icons/spin_up.svg);   width: 7px; height: 5px; }"
        "QDoubleSpinBox::down-arrow, QSpinBox::down-arrow { image: url(:/icons/spin_down.svg); width: 7px; height: 5px; }"
