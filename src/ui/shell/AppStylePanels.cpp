...
QString qssPanels()
{
    return QString(
        ...
        "QListWidget#emptyStateRecentList::item:selected       { background: rgba(@accentRgb,0.12); color: @textPrimary; }"
        "QListWidget#emptyStateRecentList::item:hover:selected { background: rgba(@accentRgb,0.22); color: @textPrimary; }"
        ...
        "QListWidget#propsHistoryList::item:selected       { background: rgba(@accentRgb,0.12); color: @textPrimary; }"
        "QListWidget#propsHistoryList::item:hover:selected { background: rgba(@accentRgb,0.22); color: @textPrimary; }"
        ...
        "}"
        "QComboBox#viewsCombo:hover    { background: @overlayEl; border-color: @overlayHov; }"
        ...
        "}"
        "QDoubleSpinBox#viewsSpin, QSpinBox#viewsSpin {"
        "  background: @overlayMut; border: 1px solid @overlayHov; border-radius: @radius2;"
        "  color: @textSecond; padding: 1px 18px 1px 6px;"
        "}"
        "QDoubleSpinBox#viewsSpin:disabled, QSpinBox#viewsSpin:disabled {"
        "  color: @textDisabled; border-color: @overlayMut;"
        "}"
        "QDoubleSpinBox#viewsSpin::up-button, QSpinBox#viewsSpin::up-button {"
        "  subcontrol-origin: border; subcontrol-position: top right;"
        "  width: 14px; border: none; background: rgba(255,255,255,0.05);"
        "}"
        "QDoubleSpinBox#viewsSpin::down-button, QSpinBox#viewsSpin::down-button {"
        "  subcontrol-origin: border; subcontrol-position: bottom right;"
        "  width: 14px; border: none; background: rgba(255,255,255,0.05);"
        "}"
        "QDoubleSpinBox#viewsSpin::up-button:hover, QSpinBox#viewsSpin::up-button:hover,"
        "QDoubleSpinBox#viewsSpin::down-button:hover, QSpinBox#viewsSpin::down-button:hover {"
        "  background: @overlayHov;"
        "}"
        "QDoubleSpinBox#viewsSpin::up-arrow,   QSpinBox#viewsSpin::up-arrow   { image: url(:/icons/spin_up.svg);   width: 7px; height: 5px; }"
        "QDoubleSpinBox#viewsSpin::down-arrow, QSpinBox#viewsSpin::down-arrow { image: url(:/icons/spin_down.svg); width: 7px; height: 5px; }"
